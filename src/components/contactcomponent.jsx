...
const ContactComponent = () => {
  ...
  return (
    <section id="contact" className="bg-[#331C52]  md:py-8 sm:py-4 h-screen " >
       ...
       Contact Me
        ...
        <div class="pb-6 grid grid-cols-1 gap-6 my-24 lg:grid-cols-2  ">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    <span class="inline-block p-3 text-white rounded-full bg-blue-100/80 ">
                    ...
                    <p class="mt-2 text-sm text-white dark:text-blue-400">hello@merakiui.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <p class="mt-2 text-sm text-white dark:text-blue-400">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-white dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-white dark:text-blue-400">+1 (555) 000-0000</p>
                </div>
            </div>

            <div class=" rounded-lg bg-[#331C52] text-white ">
            ...
            <button type="submit" className="hover:bg-[#291C3A] w-full font-semibold  text-white px-4 py-2 rounded-md bg-[#8121D0] transition-colors">
              Submit
            </button>
          </form>
            </div>
